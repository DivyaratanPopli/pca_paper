...
snakemake <- Snakemake(
    ...
    output = list('to_delete/filter409/pcs_ppca_miss/pcs_npcs2.csv', 'to_delete/filter409/pcs_ppca_miss/pcs_npcs2.csv_scores', 'to_delete/filter409/pcs_ppca_miss/pcs_npcs2_data_rec.csv', 'to_delete/filter409/pcs_ppca_miss/pcs_npcs2_sigma.txt', 'to_delete/filter409/pcs_ppca_miss/pcs_npcs2_eval.csv', "outfile" = 'to_delete/filter409/pcs_ppca_miss/pcs_npcs2.csv', "outfile_s" = 'to_delete/filter409/pcs_ppca_miss/pcs_npcs2.csv_scores', "outfile_d" = 'to_delete/filter409/pcs_ppca_miss/pcs_npcs2_data_rec.csv', "sigmaf" = 'to_delete/filter409/pcs_ppca_miss/pcs_npcs2_sigma.txt', "evalf" = 'to_delete/filter409/pcs_ppca_miss/pcs_npcs2_eval.csv'),
    params = list(),
    wildcards = list('409', 'ppca_miss', '2', "f" = '409', "method" = 'ppca_miss', "npcs" = '2'),
    threads = 1,
    log = list(),
