...
An open-source implementation of our snakemake pipeline to estimate PCA and $F$-statistics is available along with a toy example dataset, and the scripts to generate our simulations are available on GitHub \cite{popli_httpsgithubcomdivyaratanpoplipca_paper_nodate}. The analyzed Neandertal dataset was generated in previous studies, and is available in European Nucleotide Archive \cite{hajdinjak_reconstructing_nodate}.
